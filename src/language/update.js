// Code by https://github.com/whyboris/Video-Hub-App
...
const TARGET_LANGUAGE_list = ["en", "ja"]; // must coincide with the file name, e.g. `ru.json`

const API_KEY = ""; // your Google API key

import fs from "fs";

import TJOImport from "translate-json-object";
const TJO = TJOImport();

TJO.init({ googleApiKey: API_KEY });

for (const TARGET_LANGUAGE of TARGET_LANGUAGE_list) {
  const templateFile = fs.readFileSync("zh-TW.json");
