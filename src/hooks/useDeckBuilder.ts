...
export function useDeckBuilder(): UseDeckBuilderReturn {
  ...
  const [validation, setValidation] =
    useState<ValidationResult>(initialValidation);
  ...
  const removeAllCopies = useCallback(
    (cardId: string) => {
      setDeck((prev) => {
